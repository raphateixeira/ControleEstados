...
::: {.column width="50%"}
  ...
  - **Ementa Espaço de Estados**: Modelagem de sistemas físicos; Representação em espaço de estados; Análise de sistemas no espaço de estados; Controle de sistemas no espaço de estados; Observadores de estado; Estabilidade, controlabilidade e observabilidade; Projeto de controladores e observadores.

  - **Ementa Controle Digital**: Controle digital; Amostragem e reconstrução de sinais; Análise de sistemas amostrados; Projeto de controladores digitais; Implementação de controladores digitais.
...
- **Livro  3**: Dorf, Richard C., and Robert H. Bishop. "Sistemas de Controle Moderno." 13th Edition. Pearson, 2016.
...
- [25/08] - Plano de ensino; Introdução aos modelos de estado; Modelagem massa mola amortecedor;
...
- [22/04] - Exercícios de controladores por alocação de polos; 
- [23/04] - Exercícios de controladores por alocação de polos; 
- [29/04] - Teste 2 - $T_2$; Correção do teste 2;

--- 

## Plano de Ensino

- [30/04] - Observadores de estado; Observabilidade; Projeto de observadores de estado;
- [06/05] - Projeto de controladores por alocação de polos e observadores de estado; 
- [07/05] - Regulação e Rastreamento; Exercícios de projeto de controladores e observadores;
- [13/05] - Teste 3 - $T_3$; Correção do teste 3;
